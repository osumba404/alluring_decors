 ...
 * Generated at: 2025-11-17 07:23:44 UTC
...
public final class admin_002ddashboard_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("            fetch('/alluring-decors/admin/requests?action=getApproved')\n");
      out.write("                .then(response => response.json())\n");
      out.write("                .then(requests => {\n");
      out.write("                    let options = '<option value=\"\">Select Approved Request</option>';\n");
      out.write("                    requests.forEach(req => {\n");
      out.write("                        options += '<option value=\"' + req.requestId + '\">' + req.requestCode + ' - ' + req.clientName + ' (' + req.areaSqft + ' sqft)</option>';\n");
      out.write("                    });\n");
      out.write("                    \n");
      out.write("                    openModal('Generate Bill', \n");
      out.write("                        '<form method=\"post\" action=\"/alluring-decors/admin/bills\">' +\n");
      out.write("                        '<input type=\"hidden\" name=\"action\" value=\"create\">' +\n");
      out.write("                        '<div class=\"form-group\"><label>Approved Request:</label><select name=\"requestId\" required>' + options + '</select></div>' +\n");
      ...
      out.write("                .catch(error => {\n");
      out.write("                    openModal('Generate Bill', \n");
      out.write("                        '<p>Error loading approved requests. Please try again.</p>'\n");
      out.write("                    );\n");
      out.write("                });\n");
      out.write("        }\n");
      out.write("        \n");
      ...
      out.write("                '<input type=\"hidden\" name=\"action\" value=\"create\">' +\n");
      out.write("                '<div class=\"form-group\"><label>Bill ID:</label><select name=\"billId\" required><option value=\"\">Select Bill</option></select></div>' +\n");
