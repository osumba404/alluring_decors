    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        if ("true".equals(ajax)) {
            ...
            response.getWriter().println(
                "<div class='dashboard-header'><h1 class='dashboard-title'>Manage Projects</h1>" +
                "<button class='btn-primary' onclick=\"openModal('Add New Project', '" +
                ...
                "<button type=\\\"submit\\\" class=\\\"btn-primary\\\">Add Project</button></form>')\">Add Project</button></div>" +
            ...
            for (Project project : ongoingProjects) {
                response.getWriter().println(
                    ...
                    "</td><td><button onclick=\"openModal('Project Details', '" +
                    ...
                    "<div class=\\\"form-group\\\"><label>Description:</label><textarea rows=\\\"3\\\" readonly>" + project.getShortDescription() + "</textarea></div>')\">View</button> " +
                    "<a href='projects?action=delete&id=" + project.getProjectId() + "' onclick='return confirm(\"Delete this project?\")'>Delete</a></td></tr>"
                );
            }
